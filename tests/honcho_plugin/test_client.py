...
class TestResetHonchoClient:
    def test_reset_clears_singleton(self):
        ...
        # Seed the active profile's cached client through the slot's public
        # surface, then verify reset_honcho_client() clears it. (The client is
        # cached per profile in mod._honcho_client_slots, keyed by resolved
        # HERMES_HOME — see #24759 and the profile-isolation follow-up.)
        slot = mod._get_honcho_client_slot()
